...
**paco**
先将kitti15数据集的training和testing文件夹, 软链接到data/KITTI15目录下
```
# val command
python tools/eval.py --cfg_file cfgs/lightstereo/lightstereo_s_kitti.yaml --eval_data_cfg_file cfgs/kitti15_eval.yaml --pretrained_model output/LightStereo-S-KITTI.ckpt 
# 如果在yaml配置文件中的MODEL.PRETRAINED_MODEL设置了模型参数地址，则可以直接运行
python tools/eval.py --cfg_file cfgs/lightstereo/lightstereo_s_kitti.yaml --eval_data_cfg_file cfgs/kitti15_eval.yaml 

# view result
tensorboard --logdir=output/KittiDataset/LightStereo/eval/eval_tensorboard
```
...
**paco**
添加data/HjzlData/361530971.log数据
```
# my own data
python tools/infer.py --cfg_file cfgs/lightstereo/lightstereo_s_kitti.yaml --left_img_path data/HjzlData/361530971.log/images/0/138388535815.png --right_img_path data/HjzlData/361530971.log/images/1/138388535815.png --savename infer_hjzl_disp.png

# kitti data
python tools/infer.py --cfg_file cfgs/lightstereo/lightstereo_s_kitti.yaml --left_img_path data/KITTI15/training/image_2/000012_10.png   --right_img_path data/KITTI15/training/image_3/000012_10.png --savename infer_kitti15_disp.png
```

## Submit to the KITTI leaderboard
```
python tools/test_kitti.py --pretrained_model  Your_model_path --cfg_file cfgs/kitti12_eval.yaml
python tools/test_kitti.py --pretrained_model  Your_model_path --cfg_file cfgs/kitti15_eval.yaml
```
