...
# view result
tensorboard --logdir=/home/paco/work_prjs/open_prjs/OpenStereo/output/KittiDataset/LightStereo/eval/eval_tensorboard
```
...
```
# my own data
python tools/infer.py --cfg_file cfgs/lightstereo/lightstereo_s_kitti.yaml --left_img_path data/HjzlData/361530971.log/images/0/138288560012.png --right_img_path data/HjzlData/361530971.log/images/1/138288560012.png

# kitti data
python tools/infer.py --cfg_file cfgs/lightstereo/lightstereo_s_kitti.yaml --left_img_path data/KITTI15/training/image_2/000012_10.png   --right_img_path data/KITTI15/training/image_3/000012_10.png
```
